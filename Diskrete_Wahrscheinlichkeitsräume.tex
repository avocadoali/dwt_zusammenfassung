...
\label{sec:orgd83581c}
\subsection{Grundlagen}
\label{sec:org2f7b174}

\subsubsection{Definition 1}
\label{sec:orgd1ee3ac}
\begin{itemize}
...
\label{sec:orgb1dc578}
\subsubsection{Definition 12}
\label{sec:org65a4cf5}
...
\label{sec:org7b9f807}

\subsection{Grundlagen}
\label{sec:org8fb2fba}
...
\label{sec:org382e78c}
\subsubsection{Definition 29}
\label{sec:org9212e53}
...
\label{sec:org561a0b7}
TODO

\subsubsection{Varianz}
\label{sec:org827a3f5}
\begin{enumerate}
\item Definition 38
\label{sec:org4b21e9f}
...
\label{sec:orgd22447c}
\begin{enumerate}
\item Definition 45
\label{sec:org278eeab}
...
\label{sec:orgbc1db74}
\begin{enumerate}
\item Satz 49
\label{sec:org5481bd5}
...
\label{sec:orgfac94ab}

\subsection{Bernoulli Verteilung}
\label{sec:org8cb7336}
...
\label{sec:orge124d34}
\subsection{Satz 60: Markov-Ungleichung}
\label{sec:org3c77fe5}
...
\item \(Pr[A|B] = \frac{Pr[A \cap B]}{Pr[B]}\) für \(Pr[B] > 0\) (Def. bedingte ws.)
